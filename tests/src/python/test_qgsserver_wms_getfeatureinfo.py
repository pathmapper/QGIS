...
class TestQgsServerWMSGetFeatureInfo(TestQgsServerWMSTestBase):
    ...
    def testGetFeatureInfo(self):
        ...
        # Test getfeatureinfo response html only with maptip for vector layer (parameter)
        self.wms_request_compare(
            "GetFeatureInfo",
            "&layers=testlayer%20%C3%A8%C3%A9&styles=&"
            + "info_format=text%2Fhtml&transparent=true&"
    ...
    def testGetFeatureInfoFilter(self):
        ...
        self.wms_request_compare(
            ...
            + "query_layers=testlayer%20%C3%A8%C3%A9&"
            + "FEATURE_COUNT=10&FILTER=testlayer%20%C3%A8%C3%A9"
            + urllib.parse.quote(":\"NAME\" = 'two' AND \"utf8nameè\" = 'no-results'"),
        ...
        self.wms_request_compare(
            ...
            + "query_layers=testlayer%20%C3%A8%C3%A9&"
            + "FEATURE_COUNT=10&FILTER=testlayer%20%C3%A8%C3%A9"
            + urllib.parse.quote(":\"NAME\" = 'two' OR \"NAME\" = 'three'"),
        ...
        self.wms_request_compare(
            ...
            + "query_layers=testlayer%20%C3%A8%C3%A9&"
            + "FEATURE_COUNT=10&FILTER=testlayer%20%C3%A8%C3%A9"
            + urllib.parse.quote(":\"NAME\" = 'two' OR \"utf8nameè\" = 'three èé↓'"),
    ...
    def testGetFeatureInfoOGCfilterJSON(self):
        ...
        self.wms_request_compare(
            ...
            + "I=882&J=282&"
            "FILTER=<Filter><PropertyIsEqualTo><PropertyName>id</PropertyName><Literal>2</Literal></PropertyIsEqualTo></Filter>",
            "wms_getfeatureinfo_filter_ogc",
        )
        ...
        self.wms_request_compare(
            ...
            + "BBOX=44.90139177500000045,8.20339159915254967,44.90148522499999473,8.20361440084745297&"
            + "I=882&J=282&"
            "FILTER=<Filter><PropertyIsEqualTo><PropertyName>id</PropertyName><Literal>3</Literal></PropertyIsEqualTo></Filter>",
            "wms_getfeatureinfo_filter_ogc_empty",
        )
        ...
        self.wms_request_compare(
            ...
            + "<PropertyIsEqualTo><PropertyName>id</PropertyName><Literal>3</Literal></PropertyIsEqualTo></Or></Filter>",
            "wms_getfeatureinfo_filter_ogc_complex",
        )
        ...
        self.wms_request_compare(
            ...
            + "<PropertyIsEqualTo><PropertyName>id</PropertyName><Literal>3</Literal></PropertyIsEqualTo></And></Filter>",
            "wms_getfeatureinfo_filter_ogc_empty",
        )
        ...
        self.wms_request_compare(
            ...
            + "CRS=EPSG:4326&"
            + "FILTER=<Filter><And><PropertyIsEqualTo><PropertyName>id</PropertyName><Literal>2</Literal></PropertyIsEqualTo>"
            + "<PropertyIsEqualTo><PropertyName>name</PropertyName><Literal>two</Literal></PropertyIsEqualTo></And></Filter>",
            "wms_getfeatureinfo_filter_ogc",
        )
    ...
    def testGetFeatureInfoFilterAllowedExtraTokens(self):
        ...
        # REPLACE filter
        req_params["FILTER"] = (
            "layer4:REPLACE ( \"utf8nameè\" , 'three' , '____' ) != '____ èé↓'"
        )
        req = QgsBufferServerRequest(
            "?" + "&".join([f"{k}={v}" for k, v in req_params.items()])
        )
        ...
        self.server.serverInterface().reloadSettings()
        req_params["FILTER"] = (
            "layer4:LOWER ( REPLACE ( \"utf8nameè\" , 'three' , 'THREE' ) ) = 'three èé↓'"
        )
