...
bool QgsServerProjectUtils::wmsHTMLFeatureInfoUseMaptipOnly( const QgsProject &project )
{
  const QString useFormSettings = project.readEntry( QStringLiteral( "WMSHTMLFeatureInfoUseMaptipOnly" ), QStringLiteral( "/" ), "" );
  return useFormSettings.compare( QLatin1String( "enabled" ), Qt::CaseInsensitive ) == 0
         || useFormSettings.compare( QLatin1String( "true" ), Qt::CaseInsensitive ) == 0;
}
